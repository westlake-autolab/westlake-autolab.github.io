...
1. Wang T, Zheng L, Lv H, et al. A distributed joint extraction framework for sedimentological entities and relations with federated learning[J]. Expert Systems with Applications, 2023, 213: 119216.
2. Zhang J, Wang T, Wu H, et al. Sr-llm: Rethinking the structured representation in large language model[J]. arXiv preprint arXiv:2502.14352, 2025.
3. Zhang J, Wang T, Zhang Z, et al. QiMLP: Quantum-inspired Multilayer Perceptron with Strong Correlation Mining and Parameter Compression[C]//Proceedings of the AAAI Conference on Artificial Intelligence. 2025, 39(21): 22452-22460.
4. Zhang J, Wang T, Wang C, et al. Emotional Polarity Attention Mechanism for Text Sentiment Analysis[C]//International Conference on Database Systems for Advanced Applications. Singapore: Springer Nature Singapore, 2024: 3-18.
5. Hou C, Liu K, Wang T, et al. DDE KG Editor: A data service system for knowledge graph construction in geoscience[J]. Geoscience Data Journal, 2024, 11(4): 1073-1085.
