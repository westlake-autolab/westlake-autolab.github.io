---
layout: page
title: "Project 3: Autonomius Intelligence Modeling"
description: 
...
<div style="text-align:center; margin:20px 0;">
    <img src="/assets/img/proj3part1_abstract.png" alt="Neural-Symbolic Co-Architecture" width="95%">
...
<div style="text-align:center; margin:20px 0;">
    <img src="/assets/img/proj3part2_abstract.png" alt="Rule-Driven Enhancement of LLM and VLM Reasoning" width="70%">
...
Structured Representation-Driven Enhancement: We proposed the SR-LLM framework, which transforms abstract semantic representations into naturalized inputs under rule-based guidance and integrates supervised fine-tuning with hybrid datasets, leading to substantial improvements across multiple language reasoning tasks.
 b. Spatial Deformation Reasoning Benchmark: We developed Inf-Bench, a rule-based and infinitely scalable benchmark for spatial deformation reasoning, which systematically exposes the fundamental limitations of existing models in multi-step three-dimensional reasoning.

<ul>
1. <strong>Structured Representation-Driven Enhancement</strong>: We proposed the SR-LLM framework, which transforms abstract semantic representations into naturalized inputs under rule-based guidance and integrates supervised fine-tuning with hybrid datasets, leading to substantial improvements across multiple language reasoning tasks. {% cite zhang-etal-2025-sr %}
    
    <br>
    
2. <strong>Spatial Deformation Reasoning Benchmark</strong> We developed Inf-Bench, a rule-based and infinitely scalable benchmark for spatial deformation reasoning, which systematically exposes the fundamental limitations of existing models in multi-step three-dimensional reasoning. {% cite zhang2025ascending %}
</ul>
